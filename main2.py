...
async def status_task():
    while True:
        ...
        await bot.change_presence(game=discord.Game(name='218.exe | Prefix +'))
        await asyncio.sleep(20)
        await bot.change_presence(game=discord.Game(name='Willkommen zur 218.'))
        await asyncio.sleep(20)
        await bot.change_presence(game=discord.Game(name='in Division-Network'))
        await asyncio.sleep(20)
        await bot.change_presence(game=discord.Game(name='+commands für Hilfe!'))
        await asyncio.sleep(20)
